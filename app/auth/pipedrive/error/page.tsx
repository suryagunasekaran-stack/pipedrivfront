...
function PipedriveErrorContent() {
  const [displayMessage, setDisplayMessage] = useState<string>('An unexpected error occurred during Pipedrive authentication.');
  ...
  useEffect(() => {
    ...
    // If none are present, the default useState message is used.
  }, [searchParams]);

  const handleTryAgain = () => {
    router.push('/auth/pipedrive'); // Redirects to the Pipedrive auth initiation page
  };
      ...
      <div className="max-w-md w-full space-y-8 p-8 text-center">
        <div>
          ...
          <p className="text-gray-600 mb-6">
            We encountered an issue while trying to connect to your Pipedrive account.
          </p>
